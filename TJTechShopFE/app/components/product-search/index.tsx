        ...
        <>
            <div className="flex flex-col items-center w-10/12">
                <div className="flex flex-col w-full justify-center ">
                    <input type="text" placeholder="What are you looking for?" value={inputString} className="p-2 border-b border-gray-500 px-2 outline-none bg-black flex justify-center items-center w-full" onChange={changeEventHandler} />
                    {
                        inputString.length > 2
                            ?
                            products.filter((product => product.name.toLowerCase().includes(inputString.toLowerCase()) || product.sale_price != 0)).map(product => (

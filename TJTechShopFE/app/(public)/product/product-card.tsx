...
async function ProductCard(product: ProductModel) {
    return (
        <>
            <div className="shadow-xl bg-slate-900 bg-opacity-10 rounded w-full p-5">
                ...
                <div className="lg:hidden w-full flex flex-col justify-between h-full">
                    ...
                    <div className="my-5 underline underline-offset-4">
                        <Link href={`/products?brand_id=${product.brand_id}`} className="rounded px-10 py-5 text-left w-full nav-button">Shop More Products By <span className="font-semibold text-blue-200">{product.brand?.name}</span></Link>
                    </div>
                </div>

...
import getAllBrands, { deleteBrand } from "@/app/api/brand"
...
export function DeleteBrandButton(brand: BrandModel) {
        ...
        <>
            ...
            <dialog open={showDeleteMessage} className="modal z-40" id="modal2">
                <div className="border rounded font-medium shadow">
                    <p className="p-3 border-b w-full">Delete the Brand, <strong>{brand.name}</strong>?</p>

...
class CartProductModel(db.Model):
    ...
    cart = db.relationship("CartModel", backref="cart", cascade="all, delete", lazy=True)
    product = db.relationship("ProductModel", backref="products", cascade="all, delete", lazy=True)

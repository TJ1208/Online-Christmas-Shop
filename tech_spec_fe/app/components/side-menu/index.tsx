...
const SideMenu = () => {
    ...
    const toggleSideBar = () => {
        ModalToggle("side-menu", "modal-backdrop");
                ...
                <div className="flex">
                    ...
                    <dialog open={showSideBar} id="side-menu" className="side-menu mx-0 z-40">
                        <div className="flex justify-between border-b">
                            ...
                            <FontAwesomeIcon icon={faXmark} className="p-3 m-1 bg-slate-100 rounded-full h-4 btn-hover hover:cursor-pointer" onClick={toggleSideBar} />
                        </div>
                        {
                            isLoading
                                ?
                    ...
                    <dialog open={showSideBar} className="modal-backdrop z-30" id="modal-backdrop" onClick={toggleSideBar} />
                </div>
            </>
            :
            <>
                    ...
                    <div className="flex">
                        ...
                        <dialog open={showSideBar} id="side-menu" className="side-menu mx-0 z-40">
                            ...
                            <div className="flex flex-col">
                                <Link href="/admin/user" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/user' ? 'bg-orange-100' : ''}`}
                                    onClick={toggleSideBar}>Users</Link>
                                <Link href="/admin/product" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/product' ? 'bg-orange-100' : ''}`}
                                    onClick={toggleSideBar}>Products</Link>
                                <Link href="/admin/image" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/image' ? 'bg-orange-100' : ''}`}
                                    onClick={toggleSideBar}>Images</Link>
                                <Link href="/admin/order" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/order' ? 'bg-orange-100' : ''}`}
                                    onClick={toggleSideBar}>Orders</Link>
                                <Link href="/admin/past-order" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/past-order' ? 'bg-orange-100' : ''}`}
                                    onClick={toggleSideBar}>Past Orders</Link>
                                <Link href="/admin/category" className={`nav-button bg-blue-50 nav-button px-3 ${path == '/admin/category' ? 'bg-orange-100' : ''}`}
